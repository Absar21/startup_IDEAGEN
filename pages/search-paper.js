  ...
  useEffect(() => {
    if (i) {
     let offset = 0, num_results = 10
      ...
      axios.get(`https://api.semanticscholar.org/graph/v1/paper/search?query=${name}&offset=${offset}&limit=${num_results}&fields=title,authors,abstract,s2FieldsOfStudy,year`).
      then((res)=>{
