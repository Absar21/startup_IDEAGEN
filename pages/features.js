      ...
      <div className="bg-des">
        <div className="grid grid-cols-2 p-10 pt-4">
          <div style={{ marginLeft: "70px" }}>
            ...
            >
              Some of the most profitable types of construction business <br />{" "}
              in Canada. You can start it from your Area.
            </span>
          </div>
        </div>
        ...
        <div className="custom-border-2">
          ...
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4" onClick={()=>{
              router.push({
          ...
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4">
          Scalability
          </div>
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4">
