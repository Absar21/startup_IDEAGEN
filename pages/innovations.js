            ...
            >
{
  name
        ...
        <div className="custom-border-2">
          <div className="not-italic font-normal text-xl leading-6 text-white mt-10" onClick={()=>{
              router.push({
          ...
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4 cursor-pointer" onClick={()=>{
              router.push({
          ...
          <div className="not-italic font-normal text-xl leading-6 text-blue-600 mt-4 cursor-pointer" onClick={()=>{
              router.push({
          ...
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4 cursor-pointer">
          Scalability
          </div>
          <div className="not-italic font-normal text-xl leading-6 text-white mt-4 cursor-pointer">
